...
| 베이스라인 | 예산 | Total Bias | Fusion Bias | HL Proxy $\|HL\|_F^2$ | GPU |
|----------|------|-----------|------------|----------------------|-----|
| RLOO | None | 3.08e-2 | 0.000 | **4.46e-3** | GPU 3 |
| GRPO | SubsetSelect | 4.15e-1 | 6.9e-3 | **2.54e+13** | GPU 2 |
| STV | SubsetSelect | 1.07e-1 | 4.0e-3 | 7.8e-3 | GPU 2 |
...
- STV×SubsetSelect는 Fusion Bias가 4.0e-3 (비정규화) — 예산+배치결합 베이스라인의 교차항 존재 확인
