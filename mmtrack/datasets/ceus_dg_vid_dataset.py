...
class CeusDGVIDDataset(BaseVideoDataset):
    """CEUS CocoVID dataset (1 class: lesion)."""
    ...
    def _load_video_data_list(self) -> Tuple[List[dict], List]:
        ...
        for vid_id in vid_ids:
            # video category info
            raw_vid_info = coco.load_vids([vid_id])[0]
            video_category = raw_vid_info.get('category', None)
            if video_category == 'FNH':
                video_label = 0
            elif video_category == 'HCC':
                video_label = 1
            else:
                video_label = -1
            ...
            for img_id in img_ids:
                ...
                # load video category info
                raw_img_info['video_category'] = video_category  # "FNH"/"HCC"
                raw_img_info['video_label'] = video_label
