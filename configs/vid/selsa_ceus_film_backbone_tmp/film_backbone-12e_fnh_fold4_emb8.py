_base_ = [
    '../../_base_/models/faster-rcnn_r50-dc5-FiLM.py',
    '../../_base_/datasets/ceus_vid_selsa_fnh_style.py',
...
ann_path = 'annotations/video/fnh/ceus_video_fnh_fold4_'
